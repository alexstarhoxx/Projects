...
class Frame:
    ...
    def make_child_frame(self, formals, vals):
        ...
        # BEGIN PROBLEM 8
        child_frame = Frame(self) # Create a new chile Frame whose parent is SELF

        # Bind corresponding values to symbols in created child frame
        while formals is not nil:
            child_frame.define(formals.first, vals.first) # Using define method to bind a value to a symbol
